...
class MultiStream_VAE_audio(nn.Module):
    def __init__(self, dimx, dimz, n_sources=1, device='cpu', variational=True, freeze_decoder=False):
        ...
        # chans = (1350, 1012, 704, 506, 253) # 257*63 Channels are caculated as: dimx/12, dimx/16, dimx/23, dimx/32, dimx/64, zdim=dimx/506
        # chans = (215, 160, 112, 80, 40) # 257*10, zdim=5
